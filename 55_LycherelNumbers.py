...
managed so far to map it to a palindrome. In fact, 10677 is the first number to be shown to require
...
How many Lychrel numbers are there below ten-thousand?Find the smallest prime which, by replacing part
